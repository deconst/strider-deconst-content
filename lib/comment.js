...
const multiMessageHeaders = [
  'Your content preview is now ready:',
  'HULK PREVIEW'
]

const deconstJSONHelp = "I didn't find any `deconst.json` files in your content repository! See " +
...
const mappingHelp = 'Your build succeeded, but some of your content is not mapped anywhere ' +
...
const randomlyFrom = function (items) {
